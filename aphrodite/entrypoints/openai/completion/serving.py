...
class OpenAIServingCompletion(GenerateBaseServing):
        ...
        try:
            ...
            if include_usage and not compact_stream:
                ...
                if (
                    ...
                    # Suppress when not attributable to one stream.
                    and num_prompts == 1
                    and (request.n or 1) == 1
                ):
                    last_metrics = last_res.metrics if last_res is not None else None
                    stream_per_request_metrics = build_per_request_timing_metrics(last_metrics, total_completion_tokens)
    ...
    def request_output_to_completion_response(
        ...
        if (
            ...
            # they cannot be attributed to one: multiple prompts or n>1.
